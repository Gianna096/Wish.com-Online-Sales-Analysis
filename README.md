...
<img src="https://user-images.githubusercontent.com/figure3.png" width="200" />. We performed a min-max normalization for three numeric variables (price, merchant rating, and rating) to scale them to a fixed range.
